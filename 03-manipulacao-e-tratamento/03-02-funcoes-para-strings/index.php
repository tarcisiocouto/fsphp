...
var_dump([
    "string" => $string,
    /**
     * [strlen] Função que conta os caracteres. Porém, cuidado ao utilizar, pois
     * os acentos são considerados como caracteres. 
     */
    "strlen" => strlen($string),
    /**
     * [mb_strlen] Função que conta os caracteres. Os acentos NÃO são considerados
